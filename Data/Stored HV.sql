...
BEGIN TRY
	...
	BEGIN
	DECLARE @NVGIAOHANG INT = (select TOP 1 N.MANV FROM NHANVIEN N,DONHANG D WHERE D.MACN=N.MACN AND D.MADH=@MADH AND N.CHUCVU=N'Nhân viên giao hàng' ORDER BY NEWID())
